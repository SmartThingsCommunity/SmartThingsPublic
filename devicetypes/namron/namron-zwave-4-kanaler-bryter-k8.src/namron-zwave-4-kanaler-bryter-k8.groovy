/**
 *  Namron Z-Wave 4 channel switch K8
 *  Copyright 2020 Kjartan Flåm Ohr
 *
 ...
 */
metadata {
	definition (name: "Namron Z-Wave 4 kanaler bryter K8", namespace: "namron", author: "Kjartan Flåm Ohr", vid:"generic-button") {
		capability "Actuator"
		capability "Button"
        ...
        fingerprint mfr: "0438", prod: "0300", model: "A305"
