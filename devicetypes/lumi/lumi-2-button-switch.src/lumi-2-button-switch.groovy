 ...
 */
metadata {
	definition (name: "Lumi 2 Button Switch", namespace: "lumi", author: "Thonv") {
		capability "Actuator"
//		capability "Configuration"
        ...
        fingerprint profileId: "0104", deviceId: "0100", inClusters: "0000, 0003, 0004, 0005, 0006", outClusters: "0003", manufacturer: "Lumi", model: "LM-SZ2"
	...
	tiles (scale: 2){
        ...
        standardTile("ConfigureButton", "device.switch5", width: 2, height: 2, canChangeIcon: true) {
		...
		details(["switch1", "switch2", "onAll", "offAll", "switchAll", "refresh"])
	}
}
