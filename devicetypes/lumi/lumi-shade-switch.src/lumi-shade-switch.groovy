 ...
 */
metadata {
	definition (name: "Lumi Shade Switch", namespace: "lumi", author: "Thonv") {
		capability "Switch"
    	...
    	fingerprint profileId: "0104", deviceId: "0200", inClusters: "0000, 0003, 0004, 0005, 0006, 0008", outClusters: "0003", manufacturer: "Lumi", model: "LM-BZ1" 
		fingerprint profileId: "0104", deviceId: "0200", inClusters: "0000, 0003, 0004, 0005, 0006, 0008", outClusters: "0003", manufacturer: "Lumi R&D", model: "LM-BZ1"        
	}
	...
	tiles {
    	standardTile("State", "device.switch", width: 2, height: 2, canChangeIcon: true) {
			state "off", label: 'Close', action: "switch.on",  icon: "st.doors.garage.garage-closed", backgroundColor: "#ffffff", nextState: "on"
        	state "on",  label: 'Open', action: "switch.off", icon: "st.doors.garage.garage-open", backgroundColor: "#79b821", nextState: "off"
		}
		standardTile("Open", "device.onAll", decoration: "flat") {
			state "default", label: 'Open', action: "on",  icon: "st.doors.garage.garage-opening", backgroundColor: "#ffffff"
		}
		standardTile("Close", "device.offAll", decoration: "flat") {
			state "default", label: 'Close', action: "off", icon: "st.doors.garage.garage-closing", backgroundColor: "#ffffff"
		}
        controlTile("levelControl", "device.level", "slider", width: 2, height: 1, inactiveLabel: false, range:"(0..100)") {
		...
		main "State"
		details(["Open", "State", "Close", "levelControl", "level"])
	}
}
