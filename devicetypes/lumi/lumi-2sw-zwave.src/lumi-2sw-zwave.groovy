metadata {
    definition (name: " Lumi 2SW Zwave", namespace: "lumi", author: "phuclm") {
    capability "Switch"
    capability "Polling"
    ...
    fingerprint mfr: "0293", prod: "0003", model: "0012"
}
    ...
    tiles (scale:2) {
        ...
        main(["allSwitch"])
        details(["switch1","switch2","onall","offall", "allSwitch", "refresh"]
        )
    }
}
...
def refresh() {
    ...
    state.switchsState = [sw1:"bat", sw2:"bat"]
