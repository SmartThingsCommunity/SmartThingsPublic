...
metadata {
    definition (name: " Lumi 4SW Zwave", namespace: "lumi", author: "phuclm") {
    capability "Switch"
    capability "Polling"
    ...
    fingerprint mfr: "0293", prod: "0003", model: "0014"
}
    ...
    tiles (scale:2) {
        ...
        standardTile("switch4", "device.switch4", width: 3, height: 3, canChangeIcon: true) {
            state "on", label: "SW4", action: "off4", icon: "st.switches.light.on", backgroundColor: "#79b821"
            state "off", label: "SW4", action: "on4", icon: "st.switches.light.off", backgroundColor: "#ffffff"
        }
        ...
        standardTile("onall", "device.allSwitch", width: 2, height: 2, canChangeIcon: true) {
            state "on", label: "On All", action: "onAll", icon: "st.lights.multi-light-bulb-on", backgroundColor: "#ffffff"
        }
        standardTile("offall", "device.allSwitch", width: 2, height: 2, canChangeIcon: true) {
        ...
        main(["allSwitch"])
        details(["switch1","switch2","switch3","switch4","onall","offall", "allSwitch", "refresh"]
        )
    }
}
...
def refresh() {
    ...
    state.switchsState = [sw1:"bat", sw2:"bat", sw3:"bat", sw4:"bat"]
