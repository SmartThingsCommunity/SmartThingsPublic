...
metadata {
    ...
    definition (name: "SP2600ZB-SP2610ZB Sinope Outlet", namespace: "Sinope Technologies", author: "Sinope Technologies",  ocfDeviceType: "oic.d.smartplug") 
    {
        capability "Actuator"
        ...
        fingerprint manufacturer: "Sinope Technologies", model: "SP2600ZB", deviceJoinName: "Sinope SP2600ZB Smart Plug"
        fingerprint manufacturer: "Sinope Technologies", model: "SP2610ZB", deviceJoinName: "Sinope SP2610ZB Smart In-Wall Outlet"
    }
 ...
 * */
def ping() {
	def cmds = zigbee.readAttribute(0x0006, 0x0000);
...
def traceEvent(logFilter, message, displayEvent = false, traceLevel = 4, sendMessage = true) {
	...
	int filterLevel = (logFilter) ? logFilter.toInteger() : get_LOG_DEBUG()
