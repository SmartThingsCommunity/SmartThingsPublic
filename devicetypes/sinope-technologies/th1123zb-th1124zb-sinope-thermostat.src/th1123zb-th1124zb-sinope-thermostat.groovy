...
//	zigbee.configureReporting(0x0201, 0x0000, 0x29, 300, 600, 0x3200) 		//local temperature with refresh every 10 minutes.
	def cmds=[]    
	cmds += zigbee.configureReporting(0x0201, 0x0000, 0x29, 19, 301, 50) 		//local temperature
	cmds += zigbee.configureReporting(0x0201, 0x0008, 0x20, 22, 61, 10)  		//heating demand
	cmds += zigbee.configureReporting(0x0201, 0x0012, 0x29, 15, 0x0000, 50) 	//occupied heating setpoint reported only on change
	cmds += zigbee.readAttribute(0x0201,0x0002) 
