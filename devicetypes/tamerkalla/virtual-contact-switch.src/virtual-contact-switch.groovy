/*
	Device handle to setup a simulated switch with contact sensor to be used with other services like Alexa as an input sensor to trigger a routine. This works with Samsung Gear Watch Smartthings App.
	Turning switch On will trigger contact to open
    Turning switch Off will trigger contact to close
*/
metadata {
	// Define Device, Icon, and capabilities
    definition (name: "Virtual Contact Switch", namespace: "tamerkalla", author: "Tamer Kalla", deviceType:"switch", ocfDeviceType:"oic.d.switch") {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
    ...
    simulator {
		status "on": "contact:open"
		status "off": "contact:closed"
	}
