 ...
 *
 */
//fingerprint endpointId: "0B", profileId: "0104", deviceId: "0009", deviceVersion: "00", inClusters: "0000,0003,0004,00005,0006", outClusters: "0000" 
 
metadata {
    definition (name: "SZ-Outlet", namespace: "Plug_01", author: "eWeLink", ocfDeviceType: "oic.d.switch", executeCommandsLocally: true) {
        capability "Actuator"
...
//        capability "Light"
       fingerprint endpointId: "0B", profileId: "0104", deviceId: "0009", deviceVersion: "00", inClusters: "0000,0003,0004,00005,0006", outClusters: "0000", manufacturer: "SZ", model: "Plug_01", deviceJoinName: "SmartPlug(Plug_01)"
...
def refresh() {
    ...
    if (device.getDataValue("manufacturer") == "SZ") {
