...
metadata {
	definition (name: "ZigBee Lock", namespace: "smartthings", author: "SmartThings") {
		...
		fingerprint profileId: "0104", inClusters: "0000,0001,0003,0009,000A,0101,0020,0B05", outClusters: "000A,0019", manufacturer: "Yale", model: "YRD216 PBDB", deviceJoinName: "Yale Push Button Deadbolt Lock"
