 ...
 *
 *  UPDATES:  Changed from original ST implementation to add "momentary" and "relay switch" capabilities
 *		(along with implementation.)  This allows this device type to be used as a garage door in the ST
 *		mobile app "doors & locks" stuff -- garyd9
 *
...
// not really used, but needed for switch capability
def on() {
	return open()
}
