...
* FireAngel ZST-630 Smoke Detector/Alarm
...
First Alert Smoke Detector (ZSMOKE) and FireAngel ZST-630 Smoke Detector/Alarm are a Z-wave sleepy devices and checks in every 1 hour.
...
FireAngel ZST-630 Smoke Detector/Alarm One CR2 battery required
## Troubleshooting
...
* [FireAngel ZST-630 Smoke Detector/Alarm Troubleshooting Tips]
### To connect the FireAngel ZST-630 with the SmartThings Hub
```
...
Tap Ok to confirm
```
### To exclude the FireAngel ZST-630 Smoke Detector/Alarm
If the FireAngel ZST-630 Smoke Detector/Alarm was not discovered, you may need to reset, or “exclude,” the device before it can successfully connect with the SmartThings Hub. To do this in the SmartThings mobile app:
```
...
### To remove the  FireAngel ZST-630 Smoke Detector/Alarm from SmartThings
If the FireAngel ZST-630 Smoke Detector/Alarm is connected but not operating as normal, you may need to remove the device and reconnect it with the SmartThings Hub.
```
