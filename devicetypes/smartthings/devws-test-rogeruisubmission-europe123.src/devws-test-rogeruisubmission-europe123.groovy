...
metadata {
	definition (name: "DevWS Test: RogerUISubmission_Europe123", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "oic.d.switch", runLocally: true, minHubCoreVersion: '000.019.00012', executeCommandsLocally: true, genericHandler: "Zigbee") {
		capability "Actuator"
        ...
        fingerprint profileId: "0104", deviceId: "09884687867", manufacturer: "ABCD", model: "priyanka's Europe switch", deviceJoinName: "PP Europe switch"
	}
