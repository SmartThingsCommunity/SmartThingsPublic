...
metadata {
	definition (name: "Ikea Button", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "x.com.st.d.remotecontroller", mcdSync: true) {
		...
		fingerprint profileId: "0104", inClusters: "0000, 0003", outClusters: "0003, 0005, 0006, 0102", manufacturer: "SOMFY", model: "Situo 4 Zigbee", deviceJoinName: "Situo 4 Zigbee" // raw description 01 0104 0203 00 02 0000 0003 04 0003 0005 0006 0102
	}
...
def installed() {
	...
	if (isIkeaRemoteControl()) {
		numberOfButtons = 5
	} else if (isIkeaOnOffSwitch() || isIkeaOpenCloseRemote() || isSomfySituo()) {
		numberOfButtons = 2
	}
