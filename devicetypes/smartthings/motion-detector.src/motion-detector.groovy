...
metadata {
	definition (name: "Motion Detector", namespace: "smartthings", author: "SmartThings", mnmn: "SmartThings", vid: "generic-motion-9") {
		...
		fingerprint manufacturer: "Aurora", model: "MotionSensor51AU", deviceJoinName: "Motion Sensor" //raw description 22 0104 0107 00 03 0000 0003 0406 00 //Aurora Smart PIR Sensor
	}
