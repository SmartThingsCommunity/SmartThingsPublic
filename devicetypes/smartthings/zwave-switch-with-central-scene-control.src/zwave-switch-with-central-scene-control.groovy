 ...
 */
metadata {
	definition (name: "Z-Wave Switch with Central Scene Control", namespace: "smartthings", author: "jvmahon") {
		capability "Actuator"
        ...
        fingerprint mfr:"0184", prod: "4447", model: "3033", deviceJoinName: "Dragon Tech WS-100 Central Scene Wall Switch"
        fingerprint type:"1001", cc:"25,2B,2C,5B", ccOut:"5B", deviceJoinName: "Z-Wave Binary Switch with Central Scene"
...
def zwaveEvent(physicalgraph.zwave.commands.centralscenev1.CentralSceneNotification cmd) {
        ...
        switch (cmd.keyAttributes) {
           ...
           break
           default:
				if (state.debug)log.debug "Unhandled CentralSceneNotification: ${cmd}"
           break
        }
}
...
// End Central Scene Button Handling
...
def refresh() {
	if (state.debug) log.debug "Refresh Performed"
	delayBetween([
		zwave.switchBinaryV1.switchBinaryGet().format(),
		zwave.manufacturerSpecificV1.manufacturerSpecificGet().format()
	])
