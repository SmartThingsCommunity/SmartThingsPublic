...
private getChildCount() {
	if (device.getDataValue("model") == "9f76c9f31b4c4a499e3aca0977ac4494" || device.getDataValue("model") == "HY0003" || device.getDataValue("model") == "HY0097" || device.getDataValue("model") == "HS2SW3L-EFR-3.0" ) {
		...
		return 4
	} else if (device.getDataValue("model") == "E220-KR5N0Z0-HA" || device.getDataValue("model") == "ZB-SW05") {
		return 5
	} else if (device.getDataValue("model") == "E220-KR6N0Z0-HA" || device.getDataValue("model") == "ZB-SW06") {
		return 6 
