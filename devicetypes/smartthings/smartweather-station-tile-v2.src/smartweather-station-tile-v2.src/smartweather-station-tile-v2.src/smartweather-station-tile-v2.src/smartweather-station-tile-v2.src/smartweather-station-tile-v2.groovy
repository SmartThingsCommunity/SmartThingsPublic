...
metadata {
	...
	tiles {
        ...
        valueTile("windGust", "device.windGust", decoration: "flat") {
			state "default", label:'${currentValue} mph gusts'
		}
                

        valueTile("windchill", "device.windchill", decoration: "flat") {
			state "default", label:'windchill ${currentValue}°'
		}
        
        valueTile("heatIndex", "device.heatIndex", decoration: "flat") {
			state "default", label:'heat index ${currentValue}°'
		}
        
        valueTile("visibility", "device.visibility", decoration: "flat") {
			state "default", label:'visibility ${currentValue} mi'
		}
        
        valueTile("solarRadiation", "device.solarRadiation", decoration: "flat") {
			state "default", label:'solar rad. ${currentValue}°'
		}
        ...
        valueTile("pressure", "device.pressure", decoration: "flat") {
			state "default", label:'air pressure ${currentValue}'
		}
        
        valueTile("dewpoint", "device.dewpoint", decoration: "flat") {
			state "default", label:'dewpoint ${currentValue}'
		}
        
        valueTile("precipitation", "device.precipitation", decoration: "flat") {
			state "default", label:'precip ${currentValue} in'
		}
		...
		details(["temperature", "weatherIcon","feelsLike","wind","windDir","windchill","windGust","weather", "city","percentPrecip", "refresh","alert", "humidity","rise","set","light","heatIndex","visibility","uv","pressure","dewpoint","precipitation"])}
}
...
def poll() {
	...
	if (obs) {
        ...
        send(name: "windchill", value: obs.windchill_f)
        ...
        send(name: "uv", value: obs.UV)
        send(name: "pressure", value: obs.pressure_in)
        send(name: "dewpoint", value: obs.dewpoint_f)
        send(name: "precipitation", value: obs.precip_today_in)
		...
		send(name: "windGust", value: obs.wind_gust_mph)
