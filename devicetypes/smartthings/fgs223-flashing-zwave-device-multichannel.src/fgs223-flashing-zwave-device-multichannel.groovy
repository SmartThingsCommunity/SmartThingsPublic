 ...
 */
metadata {
	definition (name: "FGS223 Flashing Z-Wave Device Multichannel", namespace: "smartthings", author: "Francesco Delfino") {
		capability "Actuator"
		capability "Switch"
...
def configure() {
	commands([
      	zwave.configurationV1.configurationSet(parameterNumber: 10, size: 1, scaledConfigurationValue: 5).format(),
    	zwave.configurationV1.configurationSet(parameterNumber: 15, size: 1, scaledConfigurationValue: 5).format(),
