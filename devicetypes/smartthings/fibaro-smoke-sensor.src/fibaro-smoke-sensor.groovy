...
metadata {
	...
	preferences {
		...
		input "temperatureThreshold", "number", title: "Overheat temperature threshold", description: "Available settings: 1 or 1-100 C", range: "1..100", displayDuringSetup: true
