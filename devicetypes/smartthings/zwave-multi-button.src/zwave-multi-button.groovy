...
metadata {
	definition (name: "Z-Wave Multi Button", namespace: "smartthings", author: "SmartThings", mcdSync: true, ocfDeviceType: "x.com.st.d.remotecontroller") {
		...
		fingerprint mfr: "010F", prod: "1001", model: "1000", deviceJoinName: "Button", mnmn: "SmartThings", vid: "generic-6-button" //EU //Fibaro KeyFob
		fingerprint mfr: "010F", prod: "1001", model: "2000", deviceJoinName: "Button", mnmn: "SmartThings", vid: "generic-6-button"  //US //Fibaro KeyFob
		fingerprint mfr: "0371", prod: "0102", model: "0003", deviceJoinName: "Button", mnmn: "SmartThings", vid: "generic-4-button" //US //Aeotec NanoMote Quad
		fingerprint mfr: "0371", prod: "0002", model: "0003", deviceJoinName: "Button", mnmn: "SmartThings", vid: "generic-4-button" //EU //Aeotec NanoMote Quad
		fingerprint mfr: "0086", prod: "0101", model: "0058", deviceJoinName: "Button", mnmn: "SmartThings", vid: "generic-4-button" //US //Aeotec KeyFob
		fingerprint mfr: "0086", prod: "0001", model: "0058", deviceJoinName: "Button", mnmn: "SmartThings", vid: "generic-4-button" //EU //Aeotec KeyFob
		fingerprint mfr: "010F", prod: "1001", model: "3000", deviceJoinName: "Button", mnmn: "SmartThings", vid: "generic-6-button" //AU //Fibaro KeyFob
	}
