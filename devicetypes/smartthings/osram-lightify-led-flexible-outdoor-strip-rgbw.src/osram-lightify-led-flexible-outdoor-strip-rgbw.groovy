/* 
    Osram Flex Outdoor RGBW Light Strip
    
    Redistributed for the Outdoor version of the flex strip
...
metadata {
	definition (name: "OSRAM LIGHTIFY LED Flexible Outdoor Strip RGBW", namespace: "smartthings", author: "SmartThings") {
...
//03 0104 0102 00 09 0000 0003 0004 0005 0006 0008 0300 0B04 FC0F 01 0019
		fingerprint profileId: "0104", inClusters: "0000,0003,0004,0005,0006,0008,0300,0B04,FC0F", outClusters: "0019", manufacturer: "OSRAM", model: "LIGHTIFY OutdoorFlex RGBW"
