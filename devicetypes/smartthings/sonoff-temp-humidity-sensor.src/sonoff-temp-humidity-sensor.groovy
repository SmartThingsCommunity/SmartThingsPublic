...
metadata {
	definition(name: "SONOFF Temp/Humidity Sensor", namespace: "smartthings", author: "SmartThings", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, ocfDeviceType: "oic.d.thermostat") {
		...
		fingerprint profileId: "0104", deviceId: "0302", inClusters: "0000,0001,0003,0402,0405", manufacturer: "eWeLink", model: "TH01", deviceJoinName: "SONOFF Temperature & Humidity Sensor", vid:"SmartThings-smartthings-Xiaomi_Temperature_Humidity_Sensor"
...
def configure() {
	...
	if (manufacturer == "Heiman"|| manufacturer == "HEIMAN") {
		...
		return refresh() +
		        ...
		        zigbee.configureReporting(zigbee.POWER_CONFIGURATION_CLUSTER, 0x0021, DataType.UINT8, 30, 3600, 10) +
