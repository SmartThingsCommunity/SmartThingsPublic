...
metadata {
	definition(name: "Z-Wave Door/Window Sensor", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "x.com.st.d.sensor.contact", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, genericHandler: "Z-Wave") {
		...
		// Philio multi+
		fingerprint mfr: "0086", prod: "0002", model: "001D", deviceJoinName: "Open/Closed Sensor" //Aeotec Door/Window Sensor (Gen 5)
		fingerprint mfr: "0086", prod: "0102", model: "0070", deviceJoinName: "Open/Closed Sensor" //US //Aeotec Door/Window Sensor 6
		fingerprint mfr: "0086", prod: "0002", model: "0070", deviceJoinName: "Open/Closed Sensor" //EU //Aeotec Door/Window Sensor 6
		fingerprint mfr: "0086", prod: "0202", model: "0070", deviceJoinName: "Open/Closed Sensor" //AU //Aeotec Door/Window Sensor 6
		fingerprint mfr: "0086", prod: "0102", model: "0059", deviceJoinName: "Open/Closed Sensor" //Aeotec Recessed Door Sensor
		fingerprint mfr: "014A", prod: "0001", model: "0002", deviceJoinName: "Open/Closed Sensor" //Ecolink Door/Window Sensor
		fingerprint mfr: "014A", prod: "0001", model: "0003", deviceJoinName: "Open/Closed Sensor" //Ecolink Tilt Sensor
		fingerprint mfr: "014A", prod: "0004", model: "0003", deviceJoinName: "Open/Closed Sensor" //Ecolink Tilt Sensor
		fingerprint mfr: "011A", prod: "0601", model: "0903", deviceJoinName: "Open/Closed Sensor" //Enerwave Magnetic Door/Window Sensor
		fingerprint mfr: "014F", prod: "2001", model: "0102", deviceJoinName: "Open/Closed Sensor" //Nortek GoControl Door/Window Sensor
		fingerprint mfr: "0063", prod: "4953", model: "3031", deviceJoinName: "Open/Closed Sensor" //Jasco Hinge Pin Door Sensor
		fingerprint mfr: "019A", prod: "0003", model: "0003", deviceJoinName: "Open/Closed Sensor" //Sensative Strips
		fingerprint mfr: "0258", prod: "0003", model: "0082", deviceJoinName: "Open/Closed Sensor" //NEO Coolcam Door/Window Sensor
		fingerprint mfr: "0258", prod: "0003", model: "1082", deviceJoinName: "Open/Closed Sensor" // NAS-DS01ZE //NEO Coolcam Door/Window Sensor
		fingerprint mfr: "021F", prod: "0003", model: "0101", deviceJoinName: "Open/Closed Sensor" //Dome Door/Window Sensor
		...
		fingerprint mfr: "014A", prod: "0004", model: "0002", deviceJoinName: "Open/Closed Sensor" //Ecolink Door/Window Sensor
		...
		fingerprint mfr: "0086", prod: "0002", model: "0059", deviceJoinName: "Open/Closed Sensor" //Aeon Recessed Door Sensor
		...
		fingerprint mfr: "0214", prod: "0002", model: "0001", deviceJoinName: "Open/Closed Sensor" //BeSense Door/Window Detector
		fingerprint mfr: "0086", prod: "0002", model: "0078", deviceJoinName: "Open/Closed Sensor" //EU //Aeotec Door/Window Sensor Gen5
		fingerprint mfr: "0371", prod: "0102", model: "0007", deviceJoinName: "Open/Closed Sensor" //EU //Aeotec Door/Window Sensor 7
		fingerprint mfr: "0371", prod: "0002", model: "0007", deviceJoinName: "Open/Closed Sensor" //US           //Aeotec Door/Window Sensor 7
    		fingerprint mfr: "0060", prod: "0002", model: "0003", deviceJoinName: "Open/Closed Sensor" //US & EU //Everspring Door/Window Sensor
		fingerprint mfr: "0371", prod: "0102", model: "00BB", deviceJoinName: "Open/Closed Sensor" //US //Aeotec Recessed Door Sensor 7
		fingerprint mfr: "0371", prod: "0002", model: "00BB", deviceJoinName: "Open/Closed Sensor" //EU //Aeotec Recessed Door Sensor 7
    		fingerprint mfr: "0109", prod: "2022", model: "2201", deviceJoinName: "Open/Closed Sensor" //AU //Vision Recessed Door Sensor
	}
