...
metadata {
	definition(name: "Z-Wave Door/Window Sensor", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "x.com.st.d.sensor.contact", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, genericHandler: "Z-Wave") {
		...
		fingerprint mfr: "014F", prod: "2001", model: "0102", deviceJoinName: "GoControl Open/Closed Sensor" //Nortek GoControl Door/Window Sensor
		...
		fingerprint mfr: "0258", prod: "0003", model: "0082", deviceJoinName: "NEOCoolcam Open/Closed Sensor" //NEO Coolcam Door/Window Sensor
		fingerprint mfr: "0258", prod: "0003", model: "1082", deviceJoinName: "NEOCoolcam Open/Closed Sensor" // NAS-DS01ZE //NEO Coolcam Door/Window Sensor //NEOCoolcam Open/Closed Sensor
