...
def parse(String description) {
  ...
  if (event) {
    ...
    log.debug "0x0406 msg received, send to child event"
...
def addChildSensor(){
  log.debug "add child Motion sensor"
  def componentLabel
    ...
    log.debug "Child Motion sensor device added as $componentLabel"
	} catch (e) {
  ...
  if(childDevice != null)    childDevice.sendEvent(name: "motion", value: "inactive")
}
