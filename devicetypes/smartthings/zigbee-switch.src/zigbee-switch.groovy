...
metadata {
	definition (name: "ZigBee Switch", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "oic.d.switch", runLocally: true, minHubCoreVersion: '000.019.00012', executeCommandsLocally: true, genericHandler: "Zigbee") {
		...
		// VIMAR
		fingerprint profileId: '0104', manufacturer: 'Vimar', inClusters: '0000, 0003, 0004, 0005, 0006, 0007', model: 'On_Off_Switch_v1.0', deviceJoinName: 'Vimar 2-way Smart Switch', ocfDeviceType: "oic.d.light" // Vimar 2-way switch IoT connected mechanism (xx592)
		fingerprint profileId: '0104', manufacturer: 'Vimar', inClusters: '0000, 0003, 0004, 0005, 0006, 0007', model: 'On_Off_Switch_Module_v1.0', deviceJoinName: 'Vimar Smart Actuator Module' // Vimar IoT connected relay module (03981)
	}
