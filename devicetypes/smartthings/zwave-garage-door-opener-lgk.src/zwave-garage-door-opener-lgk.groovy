 ...
 *
 * modified by lgkahn to add switch so alexa can use and polling if needed 2014 v2. slight change to use send event
 */
metadata {
	definition (name: "Z-Wave Garage Door Opener - LGK", namespace: "smartthings", author: "SmartThings") {
		capability "Actuator"
