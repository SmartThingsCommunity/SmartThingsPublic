...
metadata {
    definition (name: "Z-Wave Door/Temp Sensor", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "x.com.st.d.sensor.contact", runLocally: true, minHubCoreVersion: '000.024.0002', executeCommandsLocally: false, mnmn: "SmartThings", vid: "generic-contact-2") {
        ...
        fingerprint mfr:"015D", prod:"2003", model:"B41C", deviceJoinName: "Open/Closed Sensor" //Inovelli Door/Temp Sensor
        fingerprint mfr:"0312", prod:"2003", model:"C11C", deviceJoinName: "Open/Closed Sensor" //Inovelli Door/Temp Sensor
        fingerprint mfr:"015D", prod:"2003", model:"C11C", deviceJoinName: "Open/Closed Sensor" //Inovelli Door/Temp Sensor
        fingerprint mfr:"015D", prod:"C100", model:"C100", deviceJoinName: "Open/Closed Sensor" //Inovelli Door/Temp Sensor
        fingerprint mfr:"0312", prod:"C100", model:"C100", deviceJoinName: "Open/Closed Sensor" //Inovelli Door/Temp Sensor
    }
