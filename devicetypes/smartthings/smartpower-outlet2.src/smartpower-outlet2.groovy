...
metadata {
	...
	definition(name: "SmartPower Outlet2", namespace: "smartthings", author: "SmartThings", mnmn: "SmartThings", vid: "generic-switch-power", ocfDeviceType: "oic.d.smartplug", runLocally: false, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false) {
		capability "Actuator"
		capability "Switch"
...
def refresh() {
    ...
    log.debug "Before state.offvalue is ${state.offvalue}"
    state.offvalue = 1
    log.debug "After state.offvalue is ${state.offvalue}"
