/*
	OSRAM Par38 On/Off/Dim Bulb
    
    Based On: Osram Tunable White 60 A19 bulb
...
metadata {
    definition (name: "OSRAM LIGHTIFY LED Par38 On/Off/Dim 60W", namespace: "smartthings", author: "SmartThings") {
