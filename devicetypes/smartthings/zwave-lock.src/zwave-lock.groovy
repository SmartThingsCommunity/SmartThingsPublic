...
metadata {
	definition (name: "Z-Wave Lock", namespace: "smartthings", author: "SmartThings", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, genericHandler: "Z-Wave") {
		...
		fingerprint mfr:"003B", prod:"6341", model:"5044", deviceJoinName: "Schlage Door Lock" //Schlage Touchscreen Deadbolt Door Lock //Schlage Door Lock
		...
		// Yale
		fingerprint mfr:"0129", prod:"0002", model:"0800", deviceJoinName: "Yale Lock" // YRD120 //Yale Touchscreen Deadbolt Door Lock
		fingerprint mfr:"0129", prod:"0002", model:"0000", deviceJoinName: "Yale Lock" // YRD220, YRD240 //Yale Touchscreen Deadbolt Door Lock
		fingerprint mfr:"0129", prod:"0002", model:"FFFF", deviceJoinName: "Yale Lock" // YRD220 //Yale Touchscreen Lever Door Lock
		fingerprint mfr:"0129", prod:"0004", model:"0800", deviceJoinName: "Yale Lock" // YRD110 //Yale Push Button Deadbolt Door Lock
		fingerprint mfr:"0129", prod:"0004", model:"0000", deviceJoinName: "Yale Lock" // YRD210 //Yale Push Button Deadbolt Door Lock
		fingerprint mfr:"0129", prod:"0001", model:"0000", deviceJoinName: "Yale Lock" // YRD210 //Yale Push Button Lever Door Lock
		fingerprint mfr:"0129", prod:"8002", model:"0600", deviceJoinName: "Yale Lock" //YRD416, YRD426, YRD446 //Yale Assure Lock
		fingerprint mfr:"0129", prod:"0007", model:"0001", deviceJoinName: "Yale Lock" //Yale Keyless Connected Smart Door Lock
		fingerprint mfr:"0129", prod:"8004", model:"0600", deviceJoinName: "Yale Lock" //YRD216 //Yale Assure Lock Push Button Deadbolt
		fingerprint mfr:"0129", prod:"6600", model:"0002", deviceJoinName: "Yale Lock" //Yale Conexis Lock
		fingerprint mfr:"0129", prod:"0001", model:"0409", deviceJoinName: "Yale Lock" // YRL-220-ZW-605 //Yale Touchscreen Lever Door Lock
		fingerprint mfr:"0129", prod:"800B", model:"0F00", deviceJoinName: "Yale Lock" // YRL216-ZW2. YRL236 //Yale Assure Keypad Lever Door Lock //Yale Lock
		fingerprint mfr:"0129", prod:"800C", model:"0F00", deviceJoinName: "Yale Lock" // YRL226-ZW2 //Yale Assure Touchscreen Lever Door Lock //Yale Lock
		fingerprint mfr:"0129", prod:"8002", model:"1000", deviceJoinName: "Yale Lock" //YRD-ZWM-1 //Yale Assure Lock //Yale Lock
		fingerprint mfr:"0129", prod:"803A", model:"0508", deviceJoinName: "Yale Lock" //YRD156 //Yale Touchscreen Deadbolt with Integrated ZWave Plus
		// Samsung
		fingerprint mfr:"022E", prod:"0001", model:"0001", deviceJoinName: "SamsungSDS Lock", mnmn: "SmartThings", vid: "SmartThings-smartthings-Samsung_Smart_Doorlock" // SHP-DS705, SHP-DHP728, SHP-DHP525 //Samsung Digital Lock
		// KeyWe
		fingerprint mfr:"037B", prod:"0002", model:"0001", deviceJoinName: "KeyWe Lock" // GKW-2000D //KeyWe Lock
		fingerprint mfr:"037B", prod:"0003", model:"0001", deviceJoinName: "KeyWe Lock" // GKW-1000Z //KeyWe Smart Rim Lock
		// Philia
		fingerprint mfr:"0366", prod:"0001", model:"0001", deviceJoinName: "Philia Lock" // PDS-100 //Philia Smart Door Lock
	}
