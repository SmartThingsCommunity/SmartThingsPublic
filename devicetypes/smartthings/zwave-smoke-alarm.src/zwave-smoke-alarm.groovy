...
metadata {
	definition (name: "Z-Wave Smoke Alarm", namespace: "smartthings", author: "SmartThings", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false) {
		...
		fingerprint mfr:"0138", prod:"0001", model:"0002", deviceJoinName: "Smoke Detector" //First Alert Smoke Detector and Carbon Monoxide Alarm (ZCOMBO)
		fingerprint mfr:"0138", prod:"0001", model:"0003", deviceJoinName: "Smoke Detector" //First Alert Smoke Detector and Carbon Monoxide Alarm (ZCOMBO)
		fingerprint mfr:"0154", prod:"0004", model:"0003", deviceJoinName: "Smoke Detector", mnmn: "SmartThings", vid: "generic-carbon-monoxide-3" //POPP Co Detector
	}
