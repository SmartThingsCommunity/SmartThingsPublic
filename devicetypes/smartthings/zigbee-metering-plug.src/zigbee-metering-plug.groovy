...
metadata {
    definition (name: "Zigbee Metering Plug", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "oic.d.smartplug", mnmn: "SmartThings",  vid: "generic-switch-power-energy") {
        ...
        fingerprint profileId: "0104", inClusters: "0000, 0003, 0004, 0006, 0009, 0702, 0B04", outClusters: "0003, 0019", manufacturer: "HEIMAN", model: "SmartPlug", deviceJoinName: "HEIMAN Outlet" //HEIMAN Smart Outlet
