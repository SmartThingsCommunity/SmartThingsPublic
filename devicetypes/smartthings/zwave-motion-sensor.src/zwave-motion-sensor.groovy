...
metadata {
	definition (name: "Z-Wave Motion Sensor", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "x.com.st.d.sensor.motion", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, genericHandler: "Z-Wave") {
		...
		fingerprint mfr: "011F", prod: "0001", model: "0001", deviceJoinName: "Motion Sensor"  // Schlage motion //Schlage Motion Sensor
		fingerprint mfr: "014A", prod: "0001", model: "0001", deviceJoinName: "Motion Sensor"  // Ecolink motion //Ecolink Motion Sensor
		fingerprint mfr: "014A", prod: "0004", model: "0001", deviceJoinName: "Motion Sensor"  // Ecolink motion + //Ecolink Motion Sensor
		fingerprint mfr: "0060", prod: "0001", model: "0002", deviceJoinName: "Motion Sensor"  // Everspring SP814 //Everspring Motion Sensor
		fingerprint mfr: "0060", prod: "0001", model: "0003", deviceJoinName: "Motion Sensor"  // Everspring HSP02 //Everspring Motion Sensor
		fingerprint mfr: "0060", prod: "0001", model: "0005", deviceJoinName: "Motion Sensor" //Everspring SP817 //Everspring Motion Detector
		fingerprint mfr: "0060", prod: "0001", model: "0006", deviceJoinName: "Motion Sensor" //Everspring Motion Detector
		fingerprint mfr: "011A", prod: "0601", model: "0901", deviceJoinName: "Motion Sensor"  // Enerwave ZWN-BPC //Enerwave Motion Sensor
		fingerprint mfr: "0063", prod: "4953", model: "3133", deviceJoinName: "Motion Sensor" //GE Portable Smart Motion Sensor
		fingerprint mfr: "0214", prod: "0003", model: "0002", deviceJoinName: "Motion Sensor" //BeSense Motion Detector
		fingerprint mfr: "027A", prod: "0001", model: "0005", deviceJoinName: "Motion Sensor" //Zooz Outdoor Motion Sensor
		fingerprint mfr: "027A", prod: "0301", model: "0012", deviceJoinName: "Motion Sensor", mnmn: "SmartThings", vid: "generic-motion-2" //Zooz Motion Sensor
	}
