 ...
 */
metadata {
	definition (name: "SmartAlert Siren", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "x.com.st.d.sensor.smoke", runLocally: true, minHubCoreVersion: '000.017.0012') {
		capability "Actuator"
		capability "Switch"
		capability "Sensor"
		capability "Alarm"
