...
metadata {
	definition (name: "Aeon Key Fob", namespace: "smartthings", author: "SmartThings", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, ocfDeviceType: "x.com.st.d.remotecontroller") {
		...
		fingerprint deviceId: "0x0101", inClusters: "0x86,0x72,0x70,0x80,0x84,0x85", deviceJoinName: "Remote Controller"
		fingerprint mfr: "0086", prod: "0101", model: "0058", deviceJoinName: "Remote Controller" //Aeotec Key Fob
		fingerprint mfr: "0086", prod: "0001", model: "0026", deviceJoinName: "Button", mnmn: "SmartThings", vid: "generic-button-2" //Aeotec Panic Button
	}
