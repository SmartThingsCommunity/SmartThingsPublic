...
metadata 
{
	definition (name: "MATRIX ZDB5100", namespace: "smartthings", author: "Kim T. Nielsen & Arturas Taskauskas", cstHandler: true, mcdSync: true ) 
	{
		...
		fingerprint mfr: "0234", prod: "0003", model: "0121", deviceJoinName: "MATRIX ZDB5100", mnmn: "SmartThings" 
	}
...
def installed() {
    ...
    createChildDevices()
     ...
     sendEvent(name: "supportedButtonValues", value: ["pushed","held","released","pushed_2x","pushed_3x"].encodeAsJson(), displayed: false)
}
        ...
        for (i in 1..4) {
            child = addChildDevice("Child Button", "${device.deviceNetworkId}:${i}", device.hubId,
                    [completedSetup: true, label: "${device.displayName} button ${i}",
                     isComponent: true, componentName: "button_$i", componentLabel: "Button $i"])
            child.sendEvent(name: "supportedButtonValues", value:["pushed","held","released","pushed_2x","pushed_3x"].encodeAsJson(), displayed: false)
            child.sendEvent(name: "button", value: "pushed", data: [buttonNumber: i], descriptionText: "$child.displayName was pushed", isStateChange: true, displayed: false)
        }
    }
}
...
def zwaveEvent(physicalgraph.zwave.commands.multichannelv3.MultiChannelCmdEncap cmd) 
{
	...
	else 
	{
        ...
        if(encapsulatedCommand.toString().contains("BasicReport")&&cmd.sourceEndPoint<6){} // Very dirty sollution for now
        else if(encapsulatedCommand.toString().contains("CentralSceneNotification")&&cmd.sourceEndPoint<6){} // Very dirty sollution for now
		else{        
...
def zwaveEvent(physicalgraph.zwave.commands.centralscenev1.CentralSceneNotification cmd) 
{
    ...
    switch (cmd.keyAttributes) {  
           case 0:
           value="pushed"
           result << createEvent(name: "button", value: value, data: [buttonNumber: button], descriptionText: "$device.displayName button $button was $value", isStateChange: true)
...
private getParametersMetadata()
{
    return [
		...
		[id:  11, size: 1, type: "number", range: "1..255", defaultValue: "5", required: false, readonly: false,
		...
		[id:  12, size: 1, type: "number", range: "1..255", defaultValue: "20", required: false, readonly: false,
		...
		[id:  13, size: 1, type: "number", range: "1..255", defaultValue: "50", required: false, readonly: false,
		...
		[id:  14, size: 4, type: "number", range: "0..4294967040", defaultValue: "4283782400", required: false, readonly: false,
		...
		[id:  15, size: 2, type: "number", range: "0..8191", defaultValue: "8191", required: false, readonly: false,
		...
		[id:  16, size: 1, type: "enum", defaultValue: "0", required: false, readonly: false,
		 ...
		 options: ["0" : "0: Standard toggle-function, the state is switched between on and off, dimming up and down (Default)",
				   ...
				   "4" : "4: Always turn on or dim up. Using this parameter, the pushbutton can only send on or dim up commands.\n" +
				         "Use this in pair with another pushbutton with value 3 (see chapter 2.6 in the manual)"]],

		[id:  17, size: 2, type: "number", range: "0..43200", defaultValue: "300", required: false, readonly: false,
		...
		[id:  18, size: 4, type: "number", range: "0..4294967295", defaultValue: "33488896", required: false, readonly: false,
		...
		[id:  19, size: 1, type: "enum", defaultValue: "0", required: false, readonly: false,
		 ...
		 options: ["0" : "0: Binary Switch Set only controls the pushbutton indicator LEDs, ON/OFF (Default)",
				   ...
				   "2" : "2: Binary Switch Set is handled as if the user had activated the pushbutton, including transmission of commands via the association groups"]],
		 
		[id:  20, size: 1, type: "enum", defaultValue: "7", required: false, readonly: false,
		 ...
		 options: ["0" : "0: Internal LED control is disabled, only external commands control the indication",
				   ...
				   "7" : "7: The LED indicator is ON for 5 seconds when the pushbutton is activated. (Default)"]],

		[id:  21, size: 1, type: "enum", defaultValue: "1", required: false, readonly: false,
		 ...
		 options: ["0" : "0: Direct control; the LED indication shows the received colour immediately, until the pushbutton is activated",
				   ...
				   "2" : "2: Color command sets the color for ON indication"]],

		[id:  22, size: 4, type: "number", range: "0..4294967295", defaultValue: "32512", required: false, readonly: false,
		...
		[id:  23, size: 4, type: "number", range: "0..4294967295", defaultValue: "32512", required: false, readonly: false,
		 ...
		 "Byte 4: LED control.\n 0 - 255. LED indicator control; see the application note about this parameter. (Default is 0)"], 
   		...
   		[id:  24, size: 1, type: "enum", defaultValue: "0", required: false, readonly: false,
		 ...
		 options: ["0" : "0: Standard toggle-function, the state is switched between on and off, dimming up and down (Default)",
      	...
      	[id:  25, size: 2, type: "number", range: "0..43200", defaultValue: "300", required: false, readonly: false,
		 name: "Timer value for pushbutton 2",
		 description: "This parameter specifies the time used in previous configuration parameter. This parameter is only applicable if previous parameter has value 1 or 2.\n" + 
		 "Values:\n0..43200: Specifies the time in seconds. Default is 300 = 5 minutes."],

		[id:  26, size: 4, type: "number", range: "0..4294967295", defaultValue: "33488896", required: false, readonly: false,
		 name: "Multilevel Switch Set values for pushbutton 1",
		 description: "This parameter specifies the Multilevel Switch value sent on a single activation of button 1.\n" + 
		 "Values:\n" +
		 "Byte 1: Disable/enable.\n 0 - 1. 1 = Enabled  a single activation will send commands to devices in association group 4. Devices will receive commands with the values set in Byte 2 and 3 (Default)\n" +
		...
		[id:  27, size: 1, type: "enum", defaultValue: "0", required: false, readonly: false,
		 name: "Binary Switch Set support for pushbutton 1.",
		 description: "This parameter specifies how received Binary Switch Set commands are handled",
		 options: ["0" : "0: Binary Switch Set only controls the pushbutton indicator LEDs, ON/OFF (Default)",
                   "1" : "1: Binary Switch Set controls the internal switch status and the pushbutton indicator LEDs",
		...
		[id:  28, size: 1, type: "enum", defaultValue: "7", required: false, readonly: false,
		...
		[id:  29, size: 1, type: "enum", defaultValue: "1", required: false, readonly: false,
		...
		[id:  30, size: 4, type: "number", range: "0..4294967295", defaultValue: "32512", required: false, readonly: false,
		...
		[id:  31, size: 4, type: "number", range: "0..4294967295", defaultValue: "32512", required: false, readonly: false,
		 ...
		 "Byte 3: Colour saturation, blue.\n 0 - 255. Specifies the saturation for the blue LEDs. (Default is 47)\n" +
		 "Byte 4: LED control.\n 0 - 255. LED indicator control; see the application note about this parameter. (Default is 0)"], 
        [id:  32, size: 1, type: "enum", defaultValue: "0", required: false, readonly: false,
		 ...
		 options: ["0" : "0: Standard toggle-function, the state is switched between on and off, dimming up and down (Default)",
      	...
      	[id:  33, size: 2, type: "number", range: "0..43200", defaultValue: "300", required: false, readonly: false,
		 name: "Timer value for pushbutton 3",
		 description: "This parameter specifies the time used in previous configuration parameter. This parameter is only applicable if previous parameter has value 1 or 2.\n" + 
		 "Values:\n0..43200: Specifies the time in seconds. Default is 300 = 5 minutes."],

		[id:  34, size: 4, type: "number", range: "0..4294967295", defaultValue: "33488896", required: false, readonly: false,
		...
		[id: 35, size: 1, type: "enum", defaultValue: "0", required: false, readonly: false,
		...
		[id:  36, size: 1, type: "enum", defaultValue: "7", required: false, readonly: false,
		...
		[id:  38, size: 4, type: "number", range: "0..4294967295", defaultValue: "32512", required: false, readonly: false,
		...
		[id:  39, size: 4, type: "number", range: "0..4294967295", defaultValue: "32512", required: false, readonly: false,
        ...
        [id:  40, size: 1, type: "enum", defaultValue: "0", required: false, readonly: false,
		 ...
		 options: ["0" : "0: Standard toggle-function, the state is switched between on and off, dimming up and down (Default)",
      	...
      	[id:  41, size: 2, type: "number", range: "0..43200", defaultValue: "300", required: false, readonly: false,
		 name: "Timer value for pushbutton 4",
		 description: "This parameter specifies the time used in previous configuration parameter. This parameter is only applicable if previous parameter has value 1 or 2.\n" + 
		 "Values:\n0..43200: Specifies the time in seconds. Default is 300 = 5 minutes."],

		[id:  42, size: 4, type: "number", range: "0..4294967295", defaultValue: "33488896", required: false, readonly: false,
		...
		[id: 43, size: 1, type: "enum", defaultValue: "0", required: false, readonly: false,
		...
		[id:  44, size: 1, type: "enum", defaultValue: "7", required: false, readonly: false,
		...
		[id:  46, size: 4, type: "number", range: "0..4294967295", defaultValue: "32512", required: false, readonly: false,
		...
		[id:  47, size: 4, type: "number", range: "0..4294967295", defaultValue: "32512", required: false, readonly: false,
