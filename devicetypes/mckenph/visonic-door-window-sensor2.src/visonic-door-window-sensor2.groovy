 ...
 *
 *  Copyright 2017 Phil McKenzie 
 *  This was a combine of Tomas Axerot and Bryan Spanger with a few edit from Me.
...
metadata {
	definition (name: "Visonic Door/Window Sensor2", namespace: "mckenph", author: "Phil McKenzie") {
		capability "Battery"
    ...
    tiles(scale: 2) {
        ...
        valueTile("contact", "device.contact", inactiveLabel: false, width: 2, height: 2) {
            state "contact", label:'${name}', unit:"${name}", icon:"st.contact.contact.closed"
 ...
 valueTile("spacer", "spacer", decoration: "flat", inactiveLabel: false, width: 1, height: 1) {
	...
	//	main(["temperature"])
	//	details(["temperature", "battery", "refresh", "configure"])
