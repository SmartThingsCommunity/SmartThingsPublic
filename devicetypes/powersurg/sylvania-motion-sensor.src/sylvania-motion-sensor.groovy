...
metadata {
	definition(name: "Sylvania Motion Sensor", namespace: "PowerSurg", author: "Sergio Castro", runLocally: false, minHubCoreVersion: '000.017.0012', executeCommandsLocally: true, mnmn: "SmartThings", vid: "generic-motion") {
		...
		fingerprint inClusters: "0000,0001,0003,0402,0500,0020,0B05", outClusters: "0019", manufacturer: "CentraLite", model: "Motion Sensor-A", deviceJoinName: "Sylvania Motion Sensor"
	}
