 ...
 *	v1.6.1 - Looks like only Hive 2 is supported with this API. Changing name of app
 */
preferences {
...
metadata {
	definition (name: "Hive Active Heating 2", namespace: "alyc100", author: "Alex Lee Yuk Cheung") {
		capability "Actuator"
		capability "Polling"
		capability "Refresh"
