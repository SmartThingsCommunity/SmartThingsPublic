...
def configure() {
  log.info "Confuguring Reporting and Bindings."
  def configCmds = [
...
private Map parseCatchAllMessage(String description) {
  ...
  switch(msg.clusterId) {
    case 1:
      ...
      break
    case 6:
      log.info 'Button Pushed Message'
    ...
    case 8:
      switch(msg.command) {
        ...
        case 3: /* brightness change stop command
          log.info 'Button Released Message'
          def result = [
            name: 'button',
            value: 'released',
          ...
          log.debug "Recieved button release command, not currently implemented!"
          //return result
          break
