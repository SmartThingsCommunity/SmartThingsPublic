 ...
 */
metadata {
	definition(name: "Nico Z-Wave Switch Secure", namespace: "narigon", author: "NicoA", ocfDeviceType: "oic.d.switch", runLocally: true, minHubCoreVersion: '000.019.00012', executeCommandsLocally: false, genericHandler: "Z-Wave") {
		capability "Switch"
		capability "Refresh"
		capability "Polling"
		capability "Actuator"
        ...
        fingerprint mfr: "7777", prod: "7777", model: "7777", deviceJoinName: "Nico Test DTH"
	}
