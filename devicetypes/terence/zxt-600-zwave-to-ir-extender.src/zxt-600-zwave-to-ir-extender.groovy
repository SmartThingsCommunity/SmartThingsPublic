 ...
 *
 * (Based on Ronald Gouldner version) 
 */
...
metadata {
    definition (name: "ZXT-600 ZWave-to-IR Extender", namespace: "terence", author: "terence", mnmn: "SmartThingsCommunity", vid: "5a8e94ce-8d47-37ea-8be1-61bdb5fa7e74") {
        ...
        //capability "faithcoast04428.thermostatcoolingsetpoint"
        capability "faithcoast04428.thermostatcoolingsetpoint"
        capability "faithcoast04428.thermostatHeatingSetpoint"
    ...
    tiles (scale: 2) {
        ...
        controlTile("heatSliderControlC", "device.heatingSetpoint", "slider", height: 1, width: 1, inactiveLabel: false, range:"(19..28)") {
            state "setHeatingSetpoint", action:"faithcoast04428.thermostatHeatingSetpoint.setHeatingSetpoint", backgroundColor: "#d04e00"
        }
        controlTile("coolSliderControlC", "device.coolingSetpoint", "slider", height: 1, width: 1, inactiveLabel: false, range:"(19..28)") {
            state "setCoolingSetpoint", action:"faithcoast04428.thermostatcoolingsetpoint.setCoolingSetpoint", backgroundColor: "#1e9cbb"
        }
...
def configure() {
    ...
    // the time consuming is up to 12s based on ZXT-600 characteristic.
