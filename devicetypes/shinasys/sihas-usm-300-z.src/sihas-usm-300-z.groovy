...
def parse(String description) {
    ...
    /*else if (map.name == "illuminance") {
		map.descriptionText = "${device.displayName} ${map.name} was ${map.value}lux"
        map.translatable = true
        //log.debug "xxx"
	}*/
...
def refresh() {
	...
	refreshCmds += zigbee.readAttribute(zigbee.POWER_CONFIGURATION_CLUSTER, 0x0020) +
        ...
        zigbee.readAttribute(0x0400/*illuminance*/, 0x0000) +
        zigbee.readAttribute(0x0406/*occupancy sensing*/, 0x0000) +
...
def configure() {
    ...
    configCmds += 
        ...
        zigbee.configureReporting(0x0400/*illuminance*/, 0x0000, DataType.UINT16, 30, 3600, 20/*20 lux*/) +
