metadata {
	definition (name: "Securifi SZ-PIR02 motion detector", namespace: "jfurtner", author: "jfurtner") {
	...
	tiles(scale:2) {
        ...
        valueTile("logEvent", "device.phraseSpoken", width: 2, height: 2, decoration: 'flat', inactiveLabel: true) {
