...
metadata {
	definition (name: "Securifi SZ-WTD01 Moisture Sensor", namespace: "jfurtner", author: "jfurtner") {
	...
	// UI tile definitions
	tiles(scale:2) {
		standardTile('moisture', 'device.moisture', width: 4, height: 2){
        ...
        valueTile("logEvent", "device.phraseSpoken", width:6, height:2) {
