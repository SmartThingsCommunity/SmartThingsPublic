/**
 *  DevWS Test: RogerUISubmission_100
 *
 *  Copyright 2020 RogerUI10 Corp qaST
 *
 ...
 */
metadata {
	definition (name: "DevWS Test: RogerUISubmission_100", namespace: "Test Switch", author: "RogerUI10 Corp qaST", cstHandler: true) {
