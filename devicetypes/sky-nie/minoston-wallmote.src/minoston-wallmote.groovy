...
private static Map getCommandClassVersions() {
    [
            ...
            0x98: 1,	// Security S0                //SecurityMessageEncapsulation
            0x9F: 1 	// Security 2
    ]
}
...
//void zwaveEvent(physicalgraph.zwave.commands.supervisionv1.SupervisionGet cmd) {//not supported by SmartThings
