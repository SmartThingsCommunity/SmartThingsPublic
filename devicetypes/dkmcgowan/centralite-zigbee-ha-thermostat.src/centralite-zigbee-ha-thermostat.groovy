...
metadata {
	definition (name: "CentraLite ZigBee HA Thermostat", namespace: "dkmcgowan", author: "dkmcgowan") {
		capability "Actuator"
    ...
    preferences {
        input title: "", description: "CentraLite ZigBee HA Thermostat v${clientVersion()}", displayDuringSetup: true, type: "paragraph", element: "paragraph"
	}
	...
	tiles(scale: 2) {
        ...
        standardTile("blank", "blank", height: 1, width: 1, inactiveLabel: false, decoration: "flat") {
        ...
        // Row 4
        valueTile("powerSource", "device.powerSource", height: 1, width: 3, inactiveLabel: false, decoration: "flat") {
			state "default", label:'Power: ${currentValue}'
		}
        valueTile("battery", "device.battery", height: 1, width: 3, inactiveLabel: false, decoration: "flat") {
			state "default", label:'Battery: ${currentValue}%'
		}
        
        main(["temperature"])
        details(["temperature", "raiseHeatLevel", "heatingSetpoint", "raiseCoolLevel", "coolingSetpoint", "lowHeatLevel", "lowerCoolLevel", "fanMode", "mode", "holdMode", "blank", "refresh", "configure","powerSource","battery"])
	}
}
