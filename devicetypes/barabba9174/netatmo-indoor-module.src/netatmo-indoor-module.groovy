 ...
 *  netatmo-indoor
 *
 *  Copyright 2017 Barbara Schiavinato
 *
 ...
 */
metadata {
	definition (name: "Netatmo Indoor Module", namespace: "barabba9174", author: "Barbara Schiavinato") {
		capability "Sensor"
	...
	tiles {
		valueTile("temperature", "device.temperature", width: 2, height: 2) {
 		...
 		main(["temperature", "humidity", "carbonDioxide"])
