...
metadata {
	definition (
		...
		vid: "e0cbe09e-fe0a-37e3-9bb3-22e66be64c52",
...
List<Map> getConfigParams() {
	return [
		...
		[num: 2, name: "Leak Alert Clear Delay", size: 4, defaultVal: 0, range:"0..3600"],
		[num: 4, name: "Low Battery Alert", size: 1, defaultVal: 20, options: [10:"10%", 20:"20% [DEFAULT]", 30:"30%", 40:"40%", 50:"50%"]],
		[num: 5, name: "Leak Alert Command for Group 2", size: 1, defaultVal: 0, options: [0:"None [DEFAULT]", 1:"On", 2:"Off"]]
	]
}
