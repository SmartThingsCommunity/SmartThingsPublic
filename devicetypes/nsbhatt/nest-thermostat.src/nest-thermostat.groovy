...
preferences {
 ...
 // for the UI
metadata {
    definition (name: "Nest Thermostat", namespace: "nsbhatt", author: "niripal@gmail.com") {
        capability "Polling"
    ...
    tiles {
        ...
        controlTile("coolSliderControl", "device.coolingSetpoint", "slider", height: 1, width: 1, inactiveLabel: false) {
            state "setCoolingSetpoint", label:'Set Cool Temp', action:"thermostat.setCoolingSetpoint",
            backgroundColors:[
                [value: 31, color: "#153591"],
                [value: 44, color: "#1e9cbb"],
                [value: 59, color: "#90d2a7"],
        ...
        controlTile("heatingSetpoint", "device.heatingSetpoint", "slider", height: 1, width: 1, inactiveLabel: false) {
            state "setheatingSetpoint", label:'Set Heat Temp', action:"thermostat.setHeatingSetpoint",
            backgroundColors:[
                [value: 31, color: "#153591"],
                [value: 44, color: "#1e9cbb"],
                [value: 59, color: "#90d2a7"],
