...
metadata {
	definition (name: "Fibaro Walli Roller Shutter Driver", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "oic.d.blind", mnmn: "SmartThings", vid: "SmartThings-smartthings-Fibaro_Roller_Shutter") {
		...
		case 151: //Operating mode
			switch(confgurationReport.scaledConfigurationValue) {
				...
				case 6: // "Roller blind with built-in driver (impulse)"
					log.info "Device is already configured as Fibaro Walli Roller Shutter Driver"
					break
			}
			break-
		default:
...
private getParameterMap() {[
		...
		[
				...
				range: "1..90000", 
				description: "This setting determines the time needed for roller blinds to reach the top. [100 = 1s]"
		],
		[
				name: "Time of down movement", key: "timeOfDownMovement", type: "range",
				parameterNumber: 157, size: 4, defaultValue: 6000,
				range: "1..90000", 
				description: "This setting determines time needed for roller blinds to reach the bottom. [100 = 1s]" 
		],
		[
