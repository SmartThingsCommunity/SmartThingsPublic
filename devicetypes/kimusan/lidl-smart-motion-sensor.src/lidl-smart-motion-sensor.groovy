 ...
 *  Adapted for Lidl Smart Motion Sensor
 *
...
metadata {
	definition(name: "Lidl Smart Motion Sensor", namespace: "kimusan", author: "KimSchulz", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, mnmn: "SmartThings", vid: "generic-motion", genericHandler: "Zigbee") {
		...
		fingerprint inClusters: "0000,0001,0003,0500,0B05", outClusters: "0019", manufacturer: "_TZ1800_fcdjzz3s", model: "TY0202", deviceJoinName: "Lidl Motion Sensor"
	}
...
def configure() {
	...
	def configCmds = zigbee.readAttribute(zigbee.POWER_CONFIGURATION_CLUSTER, batteryAttr)
