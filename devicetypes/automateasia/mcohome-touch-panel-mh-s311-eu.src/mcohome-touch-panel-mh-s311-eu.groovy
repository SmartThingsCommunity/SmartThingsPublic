/*
MCOHome Touch Panel MH-S311-EU Description

zw:L - Listening
type:1001
mfr:015F (Device manufacturer)
prod:3111 (Product Type ID)
...
metadata {
	definition (name: "MCOHome Touch Panel MH-S311-EU", namespace: "automateasia", author: "edwin") {
		capability "Switch"
		...
		command "childOn"
		command "childOff"
		fingerprint mfr: "015F", prod: "3111", model: "5102"
	}
