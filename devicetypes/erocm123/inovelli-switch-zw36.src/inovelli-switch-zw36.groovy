...
metadata {
	definition (name: "Inovelli Switch ZW36", namespace: "erocm123", author: "Eric Maycock") {
		capability "Switch"
		capability "Refresh"
		capability "Polling"
		capability "Actuator"
		...
		fingerprint mfr: "015D", prod: "0221", model: "241C"
        fingerprint mfr: "015D", prod: "2400", model: "2400"
	}
