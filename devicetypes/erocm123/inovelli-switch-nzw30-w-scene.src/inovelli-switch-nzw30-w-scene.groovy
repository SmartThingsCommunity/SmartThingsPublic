 ...
 *
 *  Temporary implementation of this device using the general purpose Dimmer Switch handler code until
 *  a new approach for handling the scene switch capabilities is developed
 *
