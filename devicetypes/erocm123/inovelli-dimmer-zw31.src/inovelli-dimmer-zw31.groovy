...
metadata {
	definition (name: "Inovelli Dimmer ZW31+", namespace: "erocm123", author: "Eric Maycock") {
		capability "Switch"
		capability "Refresh"
		capability "Polling"
		capability "Actuator"
		...
		fingerprint mfr: "015D", prod: "B111", model: "251C"
        fingerprint mfr: "051D", prod: "B111", model: "251C"
	}
