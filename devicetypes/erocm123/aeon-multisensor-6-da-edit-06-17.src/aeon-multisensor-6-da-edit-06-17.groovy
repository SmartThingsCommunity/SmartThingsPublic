 ...
 */
 ...
 metadata {
	definition (name: "Aeon Multisensor 6 (DA edit 06/17)", namespace: "erocm123", author: "Eric Maycock") {
	...
	tiles (scale: 2) {
        multiAttributeTile(name:"main", type:"generic", width:6, height:4) {
			tileAttribute("device.illuminance", key: "PRIMARY_CONTROL") {
            	attributeState "luminosity", label:'${currentValue} lux', unit:"lux", 
                backgroundColors:[
                	[value: 0, color: "#000000"],
                    [value: 20, color: "#000000"],
                    [value: 50, color: "#193347"],
                    [value: 100, color: "#1c394f"],
					[value: 150, color: "#244863"],
					[value: 300, color: "#34678e"],
					[value: 500, color: "#4181b2"],
                    [value: 1000, color: "#5db9ff"]
				]
            }
