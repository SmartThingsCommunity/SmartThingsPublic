...
metadata {
    definition (name: "Inovelli 1-Channel Outdoor Smart Plug NZW96", namespace: "erocm123", author: "Eric Maycock", vid: "generic-switch") {
        capability "Switch"
        capability "Refresh"
        capability "Polling"
        capability "Actuator"
...
def initialize() {
    ...
    cmds << zwave.configurationV1.configurationSet(scaledConfigurationValue: autoOff!=null? autoOff.toInteger() : 0, parameterNumber: 2, size: 2)
