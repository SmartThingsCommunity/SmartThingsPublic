...
metadata {
	definition (name: "Linkind  motion sensor", namespace: "Linkind", author: "Linkind", mnmn: "Linkind", vid: "generic-motion-2") {
		...
		fingerprint inClusters: "0000,0001,0003,0020,0500,0B05", manufacturer: "lk", model: "ZB-MotionSensor-D0003", deviceJoinName: "Linkind  motion sensor"
...
private Map parseIasMessage(String description) {
	...
	log.debug(zs.isAlarm1Set() ? 'motion' : 'no motion')
