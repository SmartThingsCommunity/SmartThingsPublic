...
metadata {
	definition (name: "HELTUN TPS02 Switch", namespace: "HELTUN", author: "Sarkis Kabrailian", cstHandler: true, mcdSync: true ) {
		...
		fingerprint mfr: "0344", prod: "0004", model: "0006", deviceJoinName: "HELTUN Panel"
	}
	preferences {
		input (
			title: "HE-TPS02 | HELTUN Touch Panel Switch",
...
private parameterMap() {[
	...
	[title: "Brightness Control", description: "The HE-TPS02 can adjust its display brightness automatically depending on the illumination of the ambient environment and also allows to control it manually.",
	...
	[title: "Button Number for Relays Output Control", description: "This parameter defines the relays control source",
	 name: "Selected Relay 1 Control Source", options: [
				...
				1: "Touch Button 1 (Left)",
				2: "Touch Button 2 (Right)",
	...
	[title: "Relay Inverse Mode", description: "This Parameter specifies if the relays will operate in inverse mode. Relays can operate in an inverse mode in two different ways: " +
