...
[title: "External Input Number for Relays Output Control", description: "These Parameters defines the relays control source. These parameters are available on firmware V1.4 or higher",
