...
metadata {
	definition (name: "HELTUN TPS03 Switch", namespace: "HELTUN", author: "Sarkis Kabrailian", cstHandler: true, mcdSync: true ) {
		...
		fingerprint mfr: "0344", prod: "0004", model: "0005", deviceJoinName: "HELTUN Panel"
	}
	preferences {
		input (
			title: "HE-TPS03 | HELTUN Touch Panel Switch",
...
private parameterMap() {[
	...
	[title: "Brightness Control", description: "The HE-TPS03 can adjust its display brightness automatically depending on the illumination of the ambient environment and also allows to control it manually.",
	...
	[title: "Button Number for Relays Output Control", description: "This parameter defines the relays control source",
	 name: "Selected Relay 1 Control Source", options: [
				...
				2: "Touch Button 2 (Center)",
				3: "Touch Button 3 (Bottom Right)",
