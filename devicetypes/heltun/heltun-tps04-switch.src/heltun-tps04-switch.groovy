...
metadata {
	definition (name: "HELTUN TPS04 Switch", namespace: "HELTUN", author: "Sarkis Kabrailian", cstHandler: true, mcdSync: true ) {
		...
		fingerprint mfr: "0344", prod: "0004", model: "0004", deviceJoinName: "HELTUN Panel"
	}
	preferences {
		input (
			title: "HE-TPS04 | HELTUN Touch Panel Switch",
...
private parameterMap() {[
	...
	[title: "Brightness Control", description: "The HE-TPS04 can adjust its display brightness automatically depending on the illumination of the ambient environment and also allows to control it manually.",
