...
metadata {
	definition(name: "AWAIR-ELEMENT-Local", namespace: "awair-local", author: "deanlyoung", vid: "SmartThings-Awair-Local", ocfDeviceType: "x.com.st.d.airqualitysensor") {
	...
	preferences {
		input "awairAddress", "text", type: "text", title: "Awair Element IP Address", description: "enter Awair IP address must be [ip]:[port] ", required: true
