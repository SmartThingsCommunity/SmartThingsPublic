...
metadata {
    definition (name: "Range Extender", namespace: "Rooms Beautiful", author: "Alex Feng", vid: "generic-button") {
    ...
    tiles(scale: 2) {
        multiAttributeTile(name:"totalChildren", type: "generic", width: 6, height: 4, canChangeIcon: true){
            tileAttribute ("device.totalChildren", key: "PRIMARY_CONTROL") {
            	attributeState "totalChildren", label:'${currentValue}', backgroundColor: "#00a0dc", defaultState: true
            }
