...
metadata {
	definition (name: "Aeon Labs LED Strip (Improved)", namespace: "Aeotec", author: "Chris Cheng") {
...
def reset() {
	//log.debug "reset()"
	def rst = []
    rst << zwave.configurationV1.configurationSet(scaledConfigurationValue: 2, parameterNumber: 36, size: 1)
	rst << zwave.switchColorV3.switchColorSet(red:0, green:0, blue:0, warmWhite:255, coldWhite:255)
    commands(rst)
