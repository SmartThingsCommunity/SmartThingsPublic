...
metadata {
    definition (name: "SONOFF-BASICZBR3", namespace: "Outlet", author: "SONOFF", ocfDeviceType: "oic.d.switch", executeCommandsLocally: true) {
        capability "Actuator"
...
//        capability "Light"
       fingerprint endpointId: "01", profileId: "0104", deviceId: "0009", deviceVersion: "102", inClusters: "0000,0003,0004,00005,0006", outClusters: "0000", manufacturer: "SONOFF", model: "BASICZBR3", deviceJoinName: "Basic(R3 Zigbee)"
...
def refresh() {
    ...
    if (device.getDataValue("manufacturer") == "SONOFF") {
