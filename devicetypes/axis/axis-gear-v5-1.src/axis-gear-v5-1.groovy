metadata {
    definition (name: "AXIS Gear-V5.1", namespace: "axis", author: "AXIS Labs") {  
        ...
        //fingerprint endpointID: "C4", profileId: "C25D", inClusters: "0001", outClusters: "0001", deviceJoinName: "AXIS Gear2"
...
def ping(){
	log.debug "Ping() "
    //def cmds_ping = zigbee.readAttribute(CLUSTER_BASIC, BASIC_ATTR_SWBUILDID)
    //return cmds_ping
    return refresh()
}
...
def configure() {   
    ...
    sendEvent(name: "checkInterval", value: 60 * 5, displayed: true, data: [protocol: "zigbee", hubHardwareId: device.hub.hardwareID])
...
private Map parseReportAttributeMessage(String description) {
    ...
    else if (descMap.clusterInt == CLUSTER_WINDOWCOVERING && descMap.attrInt == WINDOWCOVERING_ATTR_LIFTPERCENTAGE && state.currentVersion >= 1093) {
