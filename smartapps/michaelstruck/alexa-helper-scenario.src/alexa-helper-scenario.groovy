...
def getDeviceDesc(type){  
    ...
    if (switches || dimmers || cLights || locks || garages) {
        ...
        result += (switches || dimmers || cLights) && locks ? "\n":""
...
private def textVersion() {
    def text = "Child App Version: 2.1.0 (01/16/2016)"
}
