...
def mainPage() {
	dynamicPage(name: "mainPage", title: "Alexa Helper Scenarios", install: true, uninstall: false) {
		section {
			...
			app(name: "childScenarios", appName: "Google Home Helper-Scenario", namespace: "MichaelStruck", title: "Create New Google Home	 Scenario...", multiple: true)
		}
		section("Options") {
...
def getSwitchAbout(){
	def result = "Created by Google Home Helper SmartApp"
}
...
private def textVersion() {
    def version = "Parent App Version: 1.0.0 (10/02/2016)"
    def childCount = childApps.size()
