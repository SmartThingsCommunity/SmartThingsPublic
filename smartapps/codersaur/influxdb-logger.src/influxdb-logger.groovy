...
private getGroupName(id) {
    ...
    else if (id == '2f78632b-fa60-48c5-8a8a-25a10b8cb959') {return 'Den'}
    else if (id == '48133193-7a35-4fdf-be63-3b1d37c7f694') {return 'Basement'}
    else if (id == '6ed83191-5cea-4335-aa1d-61f0630525e7') {return 'Master Bedroom'}
    else if (id == '879bea41-5941-4d31-8536-dde44774a9dc') {return 'Garage'}
    else if (id == 'a545f640-3121-4b7c-bd1c-562520e843e0') {return 'Kitchen'}
    else {return 'Unknown'}    
}