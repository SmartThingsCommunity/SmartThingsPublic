...
def checkForPresence() {
    ...
    /*state.someonePresent = true
	state.someonePresent = runIn(14, checkForPresenceHelper, [overwrite: false])
    state.someonePresent = runIn(15, checkForPresenceHelper, [overwrite: false])
    state.someonePresent = runIn(16, checkForPresenceHelper, [overwrite: false])*/
    runIn(14, offIfEmpty)
}
