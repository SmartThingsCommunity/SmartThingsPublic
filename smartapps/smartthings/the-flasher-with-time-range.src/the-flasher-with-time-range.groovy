 ...
 *  Date: 2013-02-06
 *
 *  Modified to include time window
 *  Author:  c. mccurry
 *  Date:  2017-01-13
 */
 
definition(
    name: "The Flasher - With Time Range",
...
/* Added 2017-01-14 */    
    ...
    if ( !between ) {
        log.debug "Exiting The Flasher - Not currently between begin / end times"
        return }
    else {
        log.debug "Continuing The Flasher:  It is currently between begin / end times"
    }
