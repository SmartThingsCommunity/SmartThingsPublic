 ...
 */
definition(
    name: "SLEEPsense-out of bed",
    namespace: "samsung",
    author: "Samsung Mobileapp",
    description: "Control lights when you’re out of bed.",
...
preferences {
	page(name:"Mainpage", install:true, uninstall:true) {
        section("Control switchs when you're out of bed.") {
            input "sleepsensor", "capability.sleepSensor", title: "Select sleep Sensor", multiple: false, required: true
        }
       section("Choose devices for out of bed") {
            input "DeviceController", "capability.switch", title: "choose devices for out of bed", multiple: true, required: false
