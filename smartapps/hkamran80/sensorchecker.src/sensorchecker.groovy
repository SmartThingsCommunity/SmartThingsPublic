...
preferences {
	section("Door 1 Opened...") {
		input "door1", "capability.contactSensor", title: "Which Sensor?"
	}
    section("Door 2 Opened...") {
		input "door2", "capability.contactSensor", title: "Which Sensor?"
	}
    section("Door 3 Opened...") {
		input "door3", "capability.contactSensor", title: "Which Sensor?"
	}
