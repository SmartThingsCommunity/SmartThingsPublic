 ...
 */
definition(
    name: "SmartTiles Camera for Tablet Fullscreen ${appVersion()}",
    namespace: "625alex",
    author: "Alex Malikov",
...
def renderTile(data) {
	if (data.type == "thermostatHeat" || data.type == "thermostatCool") {
		...
		return """<a href="https://graph.api.smartthings.com/api/smartapps/installations/c5b2093d-010b-4a39-8390-5e4efb1de652/ui?access_token=95711db4-76fa-461d-be0d-5bf6953bf980"><div class="video tile h2 w2" data-link-i="$data.i"><div class="title">$data.name</div><div class="icon" style="margin-top:-82px;"><object width="960" height="540"><img src="$data.link" width="960" height="540"></object></div></div>"""
...
.camera{background-color: #000000} /*lime*/
.video {background-color:#000000} /*dropcam grey*/
