definition(
    ...
    namespace: "erocm123/Z-WaveAssociationTool",
    author: "Eric Maycock",
...
preferences {
    page(name: "mainPage", title: "Associations", install: true, uninstall: true,submitOnChange: true) {
        section {
            app(name: "association", appName: "Z-Wave Association", namespace: "erocm123/Z-WaveAssociationTool", title: "Create New Association", multiple: true)
            }
        section {
