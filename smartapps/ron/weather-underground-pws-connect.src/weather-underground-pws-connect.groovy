 ...
 *
 *  Copyright 2015 Ronnarong W
 *  Modified to compatible with SI Unit
 *  Original code from Andrew Mager
 *
...
preferences {
    ...
    section("Unit of your temperature sensor") {
        input "unitSI", "boolean", title: "SI Unit", required: true
    }
}
...
def updateCurrentWeather() {
    ...
    // Change Unit
    def utemp = temp.currentTemperature
    if ( unitSI ) {
        utemp = utemp * 9 / 5 + 32
	}
