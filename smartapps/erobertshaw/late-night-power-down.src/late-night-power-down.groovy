 ...
 */
definition(
    name: "Late night power down",
    namespace: "erobertshaw",
    author: "Aperations.com llc",
    description: "Turn off devices if they are not in use. Turn them back on later",
...
preferences {
 ...
 //   	input(name: "switches", type: "capability.switch", title: "Turn Off These Switches", required: true, multiple: true, description: null)
  //	}
   ...
   // section {
   // 	input name: "meter", type: "capability.powerMeter", title: "Power meter"
