 ...
 *  Version History:
 *
 *	 2020-12-22: v2.1 Removed Depricated set temperature option at the automation actions
 *
					...
					if(!d) {
						try {
							...
							log.info "${app.label}: updateChildDeviceConfig(): Creating device: Name: ${values.label},  DNI: ${dni}"
		                   	d = addChildDevice(app.namespace, "Evohome Heating R1.1", dni, null, values) //Chnage the name here to change the name of the device
						} catch (e) {
