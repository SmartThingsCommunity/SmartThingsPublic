 ...
 *  Door Light
 *
 *  Copyright 2015 Austin Pritchett
 *
...
definition(
    name: "Door Light",
    namespace: "com.austin,smartapp.doorlight",
    author: "Austin Pritchett",
    description: "Turn on a light when a door is opened and off when closed, Great for Closets/Storage!",
    category: "My Apps",
