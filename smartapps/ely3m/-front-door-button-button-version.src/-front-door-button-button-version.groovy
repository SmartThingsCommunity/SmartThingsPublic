 ...
 */
definition(
    name: "!Front Door Button - Button version!",
    namespace: "ELY3M",
    author: "ELY M.",
...
preferences {
	section("When this button is pressed") {
		input "master", "capability.button", title: "Where?"
	}
...
{   
	...
	subscribe(master, "button.pushed", onHandler)
	subscribe(master, "button.held", offHandler)
}
